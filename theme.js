...
(function() {
  ...
  decorateAction = function(action) {
    var example, i, len, ref1, reversedParams;
  ...
  decorateResource = function(resource) {
    ...
    for (i = 0, len = actions.length; i < len; i++) {
      action = actions[i];
      results.push(decorateAction(action));
    }
    return results;
  };
  ...
  decorateResourceGroup = function(resourceGroup) {
    ...
    for (i = 0, len = resources.length; i < len; i++) {
      ...
      results.push(decorateResource(resource));
    }
    return results;
  };
