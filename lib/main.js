...
(function() {
                  ...
                  results3.push((function() {
                    ...
                    for (q = 0, len8 = ref7.length; q < len8; q++) {
                      ...
                      results4.push((function() {
                        var error, error1, error2, error3, len10, len11, len12, len9, r, ref10, ref11, ref8, ref9, results5, s, t, u;
                        ref8 = example[name] || [];
                        results5 = [];
                        for (r = 0, len9 = ref8.length; r < len9; r++) {
                          ...
                          for (s = 0, len10 = ref9.length; s < len10; s++) {
                            ...
                            if (dataStructure.element === 'dataStructure') {
                              try {
                                item.attributes = renderAttributes(dataStructure.content[0], dataStructures);
                              } catch (error) {
                                err = error;
                                debugger;
                                if (verbose) {
  ...
  exports.render = function(input, options, done) {
    var err, error, md, slugCache, themeStyle, themeVariables, verbose;
    if (done == null) {
      done = options;
      options = {};
    }
