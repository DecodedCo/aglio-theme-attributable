...
(function() {
  ...
  decoratePayload = function(payload) {
    var _error, results;
    results = [];
    payload.hasContent = payload.description || Object.keys(payload.headers).length || payload.body || payload.schema || (function() {
      var error;
      try {
        if (payload.body) {
        ...
        if (payload.schema) {
          return payload.schema = JSON.stringify(JSON.parse(payload.schema), null, 2);
        }
      } catch (error) {
        _error = error;
        return payload;
  ...
  buildAttribute = function(attribute) {
    var ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, values;
    values = (attribute != null ? (ref1 = attribute.content) != null ? (ref2 = ref1.value) != null ? ref2.content : void 0 : void 0 : void 0) || [];
    values = values.map ? values.map(function(value) {
      return {
        value: value.content
      };
    }) : [
    ...
    return {
      name: (attribute != null ? (ref3 = attribute.content) != null ? (ref4 = ref3.key) != null ? ref4.content : void 0 : void 0 : void 0) || '',
      type: (attribute != null ? (ref5 = attribute.content) != null ? (ref6 = ref5.value) != null ? ref6.element : void 0 : void 0 : void 0) || '',
      required: (attribute != null ? (ref7 = attribute.attributes) != null ? ref7.typeAttributes.indexOf('required') : void 0 : void 0) !== -1,
      "default": (attribute != null ? (ref8 = attribute.content) != null ? (ref9 = ref8.value) != null ? (ref10 = ref9.attributes) != null ? (ref11 = ref10["default"][0]) != null ? ref11.content : void 0 : void 0 : void 0 : void 0 : void 0) || '',
      example: (attribute != null ? (ref12 = attribute.content) != null ? (ref13 = ref12.value) != null ? (ref14 = ref13.attributes) != null ? (ref15 = ref14.samples) != null ? (ref16 = ref15[0]) != null ? (ref17 = ref16[0]) != null ? ref17.content : void 0 : void 0 : void 0 : void 0 : void 0 : void 0 : void 0) || '',
      description: attribute != null ? (ref18 = attribute.meta) != null ? ref18.description : void 0 : void 0,
  ...
  decorateAttributes = function(action, parent_resource) {
    var actionAttributes, attribute, attributes, i, knownAttributes, len, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, resourceAttributes, results;
    results = [];
    knownAttributes = [];
    ...
    for (i = 0, len = attributes.length; i < len; i++) {
      ...
      if (knownAttributes[attribute.name]) {
        continue;
      }
